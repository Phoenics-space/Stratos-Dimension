...
public class ModBlocks{
    ...
    public static final Block FRAME_PORTAL = registerBlock("frame_portal", new Block(FabricBlockSettings.copyOf(Blocks.END_PORTAL_FRAME)));
    public static final Block FRAME_FILLED = registerBlock("frame_filled", new Block(FabricBlockSettings.copyOf(Blocks.REINFORCED_DEEPSLATE)));
